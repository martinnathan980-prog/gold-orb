...
function reinitialiserAvecDemo() {
  ...
  const nom = [
    ['332P20001', 'Structure boîte', '332P20001.01', '', '', '', 'Console STD', '1', '500', '140', '500', 'A', 'A', 'Cat. S', 'Qual. H225', 'Case 1', 'Bouton poussoir | Push button (ECS 7251)\nBouton poussoir | Push button (ECS 0763)', '', ''],
    ['332P20001', 'Harnais', '332P20001.03', 'HRN-2251-A', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['332P20001', 'Plaquette éclairante', '332P20001.05', '', '', 'APU, démarrage, mission SAR', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['332P94101', 'Structure boîte', '332P94101.01', '', '', '', 'Hors console', '5', '400', '200', '400', 'B', 'C', 'Cat. T', 'Qual. H225', '', 'Switch | Switch (ASNE 0567)', '', ''],
    ['332P94101', 'Plaquette éclairante', '332P94101.02', '', '', 'EOS, optronique, mission SAR', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['U880A240101', 'Harnais', 'U880A240401', 'HRN-1601-C', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['U880A240101', 'Structure boîte', 'U880A240101.01', '', '', '', 'Console STD', '2', '480', '140', '520', 'A', 'A', 'Cat. S', 'Qual. H160', 'Case 1', 'Bouton poussoir | Push button (ECS 7251)', '', ''],
    ['332N10001', 'Structure boîte', '332N10001.01', '', '', '', 'Rack', '2', '300', '200', '800', 'B', 'B', 'Cat. S', 'Qual. H225', '', 'Relais | Relay 28V (ECS 1120)', '', ''],
    ['332N10001', 'Plaquette éclairante', '332N10001.03', '', '', 'NAV, navigation, mission transport', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['332C50001', 'Harnais', '332P20001.03', 'HRN-2251-A', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['U880R30001', 'Structure boîte', 'U880R30001.01', '', '', '', 'Nez', '1', '600', '400', '1500', 'A', 'A', 'Cat. S', 'Qual. H160', 'Case 1', 'Connecteur | Circulaire (EN 3645)', '', ''],
    ['332F40001', 'Plaquette éclairante', '332F40001.02', '', '', 'FLIGHT, pilotage, mission SAR', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    ['332F40001', 'Structure boîte', '332F40001.01', '', '', '', 'Console STD', '1', '500', '140', '495', 'A', 'A', 'Cat. S', 'Qual. H225', 'Case 1', 'Bouton poussoir | Push button (ECS 7251)\nBouton poussoir | Push button (ECS 0763)', '', ''],
    ...
    ['U880D70001', 'Structure boîte', 'U880D70001.01', '', '', '', 'Console STD', '1', '500', '145', '510', 'A', 'A', 'Cat. S', 'Qual. H160', 'Case 1', 'Bouton poussoir | Push button (ECS 7251)', '', ''],
