...
function rendreCommunication(donnees, conteneur) {
  ...
  /* Sur la page du service, seulement les communications du service :
     celles des pôles se lisent dans leur espace. */
  const dossiers = dossiersDepuisCommunications(donnees, { pole: 'ETII', serviceSeul: true });
  ...
  monter(conteneur, noteOrigine(donnees), kiosque({
    ...
    titreFil: 'Communications du service',
